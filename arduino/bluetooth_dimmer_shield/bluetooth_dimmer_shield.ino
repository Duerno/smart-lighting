...
// Global variables
float cur_lightlevel = MIN_DIMMING_LEVEL; // MIN_DIMMING_LEVEL = OFF, MAX_DIMMING_LEVEL = ON
float opt_lightlevel = cur_lightlevel;
float ldr_lightlevel = cur_lightlevel;
...
void interruptRoutine() {
  ...
  float dimmingtime = ((MAX_DIMMING_LEVEL + 60 - cur_lightlevel) * AC_HALF_CYCLE_TIME) / (MAX_DIMMING_LEVEL + 60);
